...
export class Chart {
  ...
  getAspects (initialQuerent, initialQuesited, springs, houses) {
  ...
  getPerfections () {
    ...
    const aspects = this.getAspects(querent, quesited, springs, houses);
  ...
  getWayOfThePoint () {
    const judge = this.getHouse('Judge');
    const result = [];
    // TODO: use fire lines and trace the points with the aid of house.parents
  }
}
