...
=======
  ...
  getPartOfFortune () {
>>>>>>> b0fc75e8eb20a9eab3f7652f50c33a8c70edd5dd
    let count = 0;
    for (let i = 0; i < 12; i++) {
      let figure = this.seq.get(i);
  ...
  getPerfections (querentIx = this.querent, quesitedIx = this.quesited) {
    ...
    return {springs, occupation, conjunction, mutation, translation, aspects};
  }
...
=======
export function makeAspectsFor (aspects, querent, quesited) {
>>>>>>> b0fc75e8eb20a9eab3f7652f50c33a8c70edd5dd
  let direction = '';
