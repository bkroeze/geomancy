...
export class Chart {
  ...
  getPerfections (querentIx = this.querent, quesitedIx = this.quesited) {
    ...
    // console.log(querentIx, quesitedIx, 'Aspects', aspects);
    // console.log('Perfections', perfections);
    ...
    if (querentIx === this.querent && quesitedIx === this.quesited) {
      ...
      additional.forEach(added => {
        // console.log('Current', JSON.stringify(perfections));
        // console.log('Adding', JSON.stringify(added));
        addUnique(perfections, added);
        // console.log('result', JSON.stringify(perfections));
      });
    }
    return perfections;
  }
