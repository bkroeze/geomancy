...
export class Chart {
  ...
  getIndications (querentIx = this.querent, quesitedIx = this.quesited) {
    ...
    const indications = {springs, occupation, conjunction, mutation, translation, ...aspects};
    ...
    if (querentIx === this.querent && quesitedIx === this.quesited) {
      ...
      let additional = [];
      if (querentCo) {
        additional.push(this.getIndications(querentCo.house, quesitedIx));
        if (quesitedCo) {
          additional.push(this.getIndications(querentCo.house, quesitedCo.house));
        }
      }
      if (quesitedCo) {
        additional.push(this.getIndications(querentIx, quesitedCo.house));
      }
