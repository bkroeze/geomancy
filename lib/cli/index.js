...
import {TextHouseChart} from './TextHouseChart'
...
function houseCommand (args) {
  ...
  if (args.housechart) {
    console.log('\nHouse Chart\n------------');
    var houseChart = new TextHouseChart(chart);
    console.log(houseChart.toString());
  }
  if (args.indications) {
    console.log('\nIndications\n------------');
...
function builder (yargs) {
  return chartOptions(yargs)
    ...
    .option('housechart', {type: 'boolean', default: false})
